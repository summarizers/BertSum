...
def do_format_to_bert_dacon(args):
    print(time.clock())
    data_builder.format_to_bert_dacon(args)
    print(time.clock())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="greedy",
        type=str,
        help="how to generate oracle summarie   s, greedy or combination, combination will generate more accurate oracles but take much longer time.",
    )
    parser.add_argument("-map_path", default="./urls")
    parser.add_argument("-raw_path", default="../raw_dacon")
